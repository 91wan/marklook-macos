...
- v0.1.0 是源码/本地验证里程碑。
- 计划中的 v0.1.1 源码/本地验证 patch 覆盖 thumbnail determinism、public privacy gates、固定浅色 thumbnail appearance policy 文档，以及中文 README。
- Preview、thumbnail、diagnostics 和 debug packaging 已纳入 v0.1.0 release candidate gate。
...
v0.1.1 的源码/本地验证 patch 边界见 `Docs/v0.1.1-source-local-validation.md`。`v0.1.1` tag 仍需要 merge 后、latest main 最终验证通过后，由 owner 第二次明确批准。
